        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.separated(
              ...
              separatorBuilder: (context, index) => const SizedBox(width: 15),
              itemBuilder: (context, index) {
                // ✅ نسخ الكائن لضمان أنه قابل للتعديل
                var cObj = Map<String, dynamic>.from(
                    widget.serviceArr[index] as Map? ?? {});

                // ✅ السعر الثابت
                double estFixedPrice = 0.0;
                try {
                  // ✅ الصحيح:
                  estFixedPrice = double.parse(cObj["total_estimated_amount"]
                      .toString()
                      .replaceAll(",", ""));

                  print("✅ est_price = $estFixedPrice");
                } catch (_) {
                  estFixedPrice = 0.0;
                }
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "\$${estFixedPrice.toStringAsFixed(0)}", // ← السعر الثابت
                              style: TextStyle(
                                color: TColor.primary,
                                fontSize: 17,
                                fontWeight: FontWeight.w700,
          ...
          Padding(
            ...
            child: RoundButton(
              ...
              onPressed: () {
                Navigator.pop(context);
                widget.didSelect(
                    Map<String, dynamic>.from(widget.serviceArr[selectIndex]));
              },
            ),
          ),
          const SizedBox(height: 15),
