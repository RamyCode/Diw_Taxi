...
class _UserRunRideViewState extends State<UserRunRideView> {
  ...
  void _loadMapData(latlong.LatLng pickupPoint, latlong.LatLng dropPoint) {
    markers.clear();
    polylines.clear();
    ...
    final distance =
        const latlong.Distance().distance(pickupPoint, dropPoint) / 1000;
    final time = distance / 50 * 60; // Assuming 50 km/h speed

    setState(() {
      timeCount = time.toStringAsFixed(1);
      km = distance.toStringAsFixed(1);
    });
