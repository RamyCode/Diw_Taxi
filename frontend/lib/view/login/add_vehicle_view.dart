...
import 'package:taxi_app/common_widget/drop_down_button.dart';
...
class _AddVehicleViewState extends State<AddVehicleView> {
  ...
  void submitCarAction() {
    ...
    submitCarApi({
      ...
      "brand": otherFlag == 1
          ? txtBrandName.text
          : selectBrandObj!["brand_id"].toString(),
      "model": otherFlag > 0 && otherFlag <= 2
          ? txtModelName.text
          : selectModelObj!["model_id"].toString(),
      "series": otherFlag > 0
          ? txtSeries.text
          : selectSeriesObj!["series_id"].toString(),
